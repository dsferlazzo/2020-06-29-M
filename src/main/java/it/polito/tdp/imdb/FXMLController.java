...
public class FXMLController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	if(anno==null) {
    		txtResult.appendText("Selezionare un valore nel campo anno");
    		return;
    	}
    	txtResult.appendText(model.creaGrafo(anno));
    	boxRegista.getItems().clear();
    	boxRegista.getItems().addAll(this.model.getDirectors());
    }
    ...
    void doRegistiAdiacenti(ActionEvent event) {
    	...
    	if(d==null) {
    		txtResult.appendText("Selezionare un valore nel campo regista");
    		return;
    	}
    ...
    void doRicorsione(ActionEvent event) {
    	int attoriCondivisi = Integer.parseInt(txtAttoriCondivisi.getText());	
    	Director regista = boxRegista.getValue();	//IMPLEMENTARE CONTROLLI DELL'INPUT
    	
    	txtResult.clear();
    	txtResult.appendText(this.model.doRicorsione(attoriCondivisi, regista));
    }
